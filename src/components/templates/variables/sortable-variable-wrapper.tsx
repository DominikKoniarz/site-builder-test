...
const sortableVariableContextInitialValue: ContextType = {
    attributes: {
...
const SortableVariableWrapperContext = createContext<ContextType>(
    sortableVariableContextInitialValue,
);
        ...
        <SortableVariableWrapperContext
            value={{
                attributes: isMounted
                    ? attributes
                    : sortableVariableContextInitialValue.attributes,
                listeners,
            }}
        >
            {isMounted ? (
